...
public class WorkStatusValidator : AbstractValidator<WorkStatusRequest>
{
    public WorkStatusValidator(OrgChartContext _context, IHttpContextAccessor _httpContext)
    {
